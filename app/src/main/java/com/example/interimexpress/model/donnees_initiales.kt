...
object InitialData {
    ...
    val offres = listOf(
        Offre(
            id = "2",
            titre = "Stage Data Analyst - Paris (F/H)",
        ...
        ,Offre(
            id = "4",
            titre = "Alternance Ressources Humaines - Paris (F/H)",
            entreprise = "LVMH",
            adresse = "Paris",
            cp ="75000",
        ...
        ,Offre(
            id = "7",
            titre = "Alternance Développeur Full Stack - Paris (F/H)",
            entreprise = "Google",
            adresse = "Paris",
            cp ="75000",
        ...
        ,Offre(
            id = "10",
            titre = "CDD Analyste Financier - Lyon (F/H)",
        ...
        ,Offre(
            id = "13",
            titre = "Stage Analyste Marketing - Paris (F/H)",
