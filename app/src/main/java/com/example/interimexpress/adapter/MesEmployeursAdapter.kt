...
class MesEmployeursAdapter(private val gestionnaires: MutableList<Employeur>, private val itemClickListener: OnItemClickListener) : RecyclerView.Adapter<MesEmployeursAdapter.GestionnaireViewHolder>() {

    interface OnItemClickListener {
        fun onDeleteClick(gestionnaire: Employeur)
    }
